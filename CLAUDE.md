...
- Motion rules: nothing loops except the live tile and the station cat, nothing autoplays below the fold, every animation has a reduced-motion fallback (`data-rm` on `.root` and the media query).
